...
// prepare and bind
      ...
      //  $stmt->bind_param("sssss", $DivName, $DivHead, $DivCon, $DivMail, $DivLoc);
		...
		$sql1=" INSERT INTO tbl_division(Name, Division_Head, Contact_Number, Email, Location) VALUES ($DivName, $DivHead, $DivCon, $DivMail, $DivLoc)";
       // echo $sql1;
		//$stmt->execute();
    if ($con->query($sql1) === TRUE) {
                 {

               $error2 = "New division created successfully";
