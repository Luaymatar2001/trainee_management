...
//for error msgs
    $allerror = $Full_Name_err1 = $std_err =  $superr = $diverr = $T_id_err = $Title_err=$Title_err1 = $Full_Name_err = $Name_with_Initials_err = $NIC_err = $Age_err = $Gender_err = $DOB_err = $Add_Line1_err = $Add_Line2_err = $Add_Line3_err = $Temp_Add_Line1_err = $Temp_Add_Line2_err = $Temp_Add_Line3_err = $Contact_Number1_err = $Contact_Number2_err = $E_Mail_err = $tblTrainingInstituteID_err = $ProgramName_err = $tblCourseID_err = $Batch_err = $Year_err = $Contact_Person_err = $Contact_number_err = $Relationship_err = $Address_err = $tblBankID_err = $Name_as_Bank_err = $Bank_Account_number_err = $flag_err = $branch_err = "";
//data catchiing
    $T_id = $id = $cname= $T_id2 = $Title1 = $Div1s = $Div1e = $Div2s = $Div2e = $Div3s = $Div3e = $Div4s = $Div4e = $Div5s = $Div5e = $Div6s = $Div6e = $job = $ntrain = $Title = $Topic= $project = $P1 = $P2 = $P3 = $div = $Dv3 = $Dv2 = $Dv1 = $Dv4 = $Dv5 = $Dv6 = $SDAY = $EDAY = $Sup = $DIVI = $Name = $Name_with_Initials = $NIC = $Age = $Gender = $DOB = $Add_Line1 = $Add_Line2 = $Add_Line3 = $Temp_Add_Line1 = $Temp_Add_Line2 = $Temp_Add_Line3 = $Contact_Number1 = $Contact_Number2 = $E_Mail = $tblTrainingInstituteID = $ProgramName = $tblCourseID = $Batch = $Year = $Contact_Person = $Contact_number = $Relationship = $Address = $tblBankID = $Name_as_Bank = $Bank_Account_number = $flag = $branch ="";
    ...
    if ($selectOption == "--SELECT--") {
        ...
        if (empty($_POST["v_cname"])) {
            $Full_Name_err1 = " Full Name is required.";
        // } else if (!preg_match('/^[A-z0-9\/\-\s]+$/', $_POST["v_id"])) {
        //     $Bank_Account_number_err = "Invalid ID number.";
        } else {
            $cname = $_POST["v_cname"];
    ...
    if (empty($_POST["v_NIC"])) {
        $Title_err1 = "NIC number is required.";
    } else if (!preg_match("/^[0-9]{9}[x|X|v|V]||[0-9]{12}$/", $_POST["v_NIC"])) {
        $Title_err1 = "Please Enter valid NIC.";
    } else {
        $Full_Name = $_POST["v_NIC"];
    ...
    if (empty($_POST["v_Sday"])) {
        ...
        $Name_with_Initials = $_POST["v_Sday"];
    }
...
$sql1 = "INSERT INTO tbl_apply ( Trainee_ID, tname, NIC, Sday, Eday, Div1, Div2, Div3, Div4, Div5, Div6, job, Notrain, Topic , Project, P1, P2, P3, Supervisor, Division, Div1s, Div1e, Div2s, Div2e, Div3s, Div3e, Div4s, Div4e, Div5s, Div5e, Div6s, Div6e, cname, title)
VALUES( '$T_id2' , '$Title','$Full_Name','$Name_with_Initials','$EDAY','$Dv1','$Dv2','$Dv3', '$Dv4', '$Dv5', '$Dv6', '$job', '$ntrain', '$Topic', '$project', '$P1', '$P2', '$P3', '$Sup', '$DIVI', '$Div1s', '$Div1e', '$Div2s', '$Div2e', '$Div3s', '$Div3e', '$Div4s', '$Div4e', '$Div5s', '$Div5e', '$Div6s', '$Div6e', '$cname', '$Title1')";
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_id" id="v_id"
                                           placeholder="Trainee ID" onblur="this.value=this.value.toUpperCase()" value="<?php echo  $T_id2; ?><?php if (isset($_POST['btnSubmit'])) {
                                         $_POST['v_id'];
                                    } ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_tname" id="v_tname"
                                           placeholder="Full Name" onblur="this.value=this.value.toUpperCase()" value="<?php echo  $Title; ?><?php if (isset($_POST['btnSubmit'])) {
                                         $_POST['v_tname'];
                                    } ?>">                                               
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
                            ...
                            <div class="form-group">
                                <label for="inputText1" class="col-sm-4 control-label">Name For Certificate *</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_cname" id="v_cname"
                                           placeholder="Name For Certificate" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                         $_POST['v_cname'];
                                    } ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>

                                    <span class="text-danger"><?php echo $Full_Name_err1; ?></span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_NIC" id="v_NIC"
                                           placeholder="NIC Number" onblur="this.value=this.value.toUpperCase()" value="<?php echo  $Full_Name; ?><?php if (isset($_POST['btnSubmit'])) {
                                         $_POST['v_NIC'];
                                    } ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>

                                    <span class="text-danger"><?php echo $Title_err1; ?></span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_Sday" id="v_Sday"
                                           placeholder="Date of Start" value="<?php echo  $Name_with_Initials; ?><?php if (isset($_POST['btnSubmit'])) {
                                         $_POST['v_Sday'];
                                    } ?>">
                                </div>                              
                                <?php if (isset($_POST["btnSubmit"])) { ?>
