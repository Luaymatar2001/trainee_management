...
<body data-spy="scroll" data-target=".navbar" data-offset="50" class="hero-image">
    ...
    <?php if (isset($_POST["btnSubmit"])) { ?>
        ...
        <?php } elseif (!empty($error2)) { ?>
            <div class="col-sm-8 col-sm-offset-2 text-center alert alert-success" role="alert"> <?php echo $error2; ?> </div>
    <?php }
    } ?>
    ...
    <center>
        ...
        <form class="form-horizontal" method="post" action="#" enctype="multipart/form-data">
            ...
            <input name="token" hidden id="token" value="" />
                        ...
                        <div>
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_fname" id="v_Fname" placeholder="Full Name" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                            echo $_POST['v_fname'];
                                                                                                                                                                                        } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_initials" id="v_initials" placeholder="Name with initials" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_nic" id="v_nic" placeholder="NIC Number" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                            echo $_POST['v_nic'];
                                                                                                                                                                                        } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="date" class="form-control" name="v_dob" id="v_dob" placeholder="Date of birth" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                echo $_POST['v_dob'];
                                                                                                                                            } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_age" id="v_age" placeholder="Age " onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                    echo $_POST['v_age'];
                                                                                                                                                                                } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_add1" id="v_add1" placeholder="Address Line 1" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                                echo $_POST['v_add1'];
                                                                                                                                                                                            } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_add2" id="v_add2" placeholder="Address Line 2" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                                echo $_POST['v_add2'];
                                                                                                                                                                                            } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_add3" id="v_add3" placeholder="Address Line 3" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                                echo $_POST['v_add3'];
                                                                                                                                                                                            } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_tadd1" id="v_tadd1" placeholder="Temp. Address Line 1" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                                        echo $_POST['v_tadd1'];
                                                                                                                                                                                                    } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_tadd2" id="v_tadd2" placeholder="Temp. Address Line 2" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                                        echo $_POST['v_tadd2'];
                                                                                                                                                                                                    } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_tadd3" id="v_tadd3" placeholder="Temp. Address Line 3" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                                        echo $_POST['v_tadd3'];
                                                                                                                                                                                                    } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_mob1" id="v_mob1" placeholder="Mobile Number" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                                echo $_POST['v_mob1'];
                                                                                                                                                                                            } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_fno" id="v_fno" placeholder="Fixed Number" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                            echo $_POST['v_fno'];
                                                                                                                                                                                        } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="email" class="form-control" name="v_email" id="v_email" placeholder="E-mail" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                echo $_POST['v_email'];
                                                                                                                                            } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                        ...
                        <div>
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" name="v_institute" id="v_institute" value="<?php if (isset($_POST['btnSubmit'])) {
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" name="v_program" id="v_program" value="<?php if (isset($_POST['btnSubmit'])) {
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" name="v_course" id="v_course" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                echo $_POST['v_course'];
                                                                                                            } ?>">
                                            <option value="0">--SELECT--</option>
                                            <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_batch" id="v_batch" placeholder="EX:2016/17" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                                echo $_POST['v_batch'];
                                                                                                                                                                                            } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_year" id="v_year" placeholder="Year" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                        echo $_POST['v_year'];
                                                                                                                                                                                    } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                        ...
                        <div>
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" name="v_stream" id="v_stream" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                echo $_POST['v_stream'];
                                                                                                            } ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control" name="v_sub" id="v_sub" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                        echo $_POST['v_sub'];
                                                                                                    } ?>">
                                            <option value="NOT PROVIDED">--SELECT--</option>
                                            <?php
                                    ...
                                    <!-- start -->
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="v_res1" id="v_res1" placeholder=" Result" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                        echo $_POST['v_res1'];
                                                                                                                                                                                    } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="inputText2" class="col-sm-4 control-label">Subject and Result</label>
                                    <div class="col-sm-4">
                                        <select class="form-control" name="v_sub2" id="v_sub2" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                            echo $_POST['v_sub2'];
                                                                                                        } ?>">
                                            <option value="NOT PROVIDED">--SELECT--</option>
                                            <?php
                                    ...
                                    <!-- start -->
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="v_res2" id="v_res2" placeholder=" Result" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                        echo $_POST['v_res2'];
                                                                                                                                                                                    } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="inputText2" class="col-sm-4 control-label">Subject and Result</label>
                                    <div class="col-sm-4">
                                        <select class="form-control" name="v_sub3" id="v_sub3" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                            echo $_POST['v_sub3'];
                                                                                                        } ?>">
                                            <option value="NOT PROVIDED">--SELECT--</option>
                                            <?php
                                    ...
                                    <!-- start -->
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="v_res3" id="v_res3" placeholder=" Result" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                        echo $_POST['v_res3'];
                                                                                                                                                                                    } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_gt" id="v_gt" placeholder="Genaral Test Mark" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                                echo $_POST['v_gt'];
                                                                                                                                                                                            } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_ge" id="v_ge" placeholder="Genaral English Mark" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                                    echo $_POST['v_ge'];
                                                                                                                                                                                                } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" name="v_dis" id="v_dis" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                        echo $_POST['v_dis'];
                                                                                                    } ?>">
                                            <option value="--NOT PROVIDED--">--SELECT--</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_disR" id="v_disR" placeholder="District Rank" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                                echo $_POST['v_batch'];
                                                                                                                                                                                            } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_ir" id="v_ir" placeholder="Island Rank" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                        echo $_POST['v_ir'];
                                                                                                                                                                                    } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_zc" id="v_zc" placeholder="Z Score" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                    echo $_POST['v_zc'];
                                                                                                                                                                                } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_gpa" id="v_gpa" placeholder="GPA" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                    echo $_POST['v_gpa'];
                                                                                                                                                                                } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_com" id="v_com" placeholder="Comment" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                        echo $_POST['v_com'];
                                                                                                                                                                                    } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                        ...
                        <div>
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_con" id="v_con" placeholder="Contact Person" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                                echo $_POST['v_con'];
                                                                                                                                                                                            } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_conNo" id="v_conNo" placeholder="Contact Number" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                                    echo $_POST['v_conNo'];
                                                                                                                                                                                                } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_conRel" id="v_conRel" placeholder="Relationship" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                                    echo $_POST['v_conRel'];
                                                                                                                                                                                                } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_conAdd" id="v_conAdd" placeholder="Address" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                            echo $_POST['v_conAdd'];
                                                                                                                                                                                        } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                        ...
                        <div>
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" name="v_bank" id="v_bank" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                            echo $_POST['v_bank'];
                                                                                                        } ?>">
                                            <option value="0">--SELECT--</option>
                                            <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_branch" id="v_branch" placeholder="Branch" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                                                            echo $_POST['v_branch'];
                                                                                                                                                                                        } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_nameBank" id="v_nameBank" placeholder="Name As Bank" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_accNO" id="v_accNO" placeholder="Account Number" value="<?php if (isset($_POST['btnSubmit'])) {
                                                                                                                                                    echo $_POST['v_accNO'];
                                                                                                                                                } ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
...
<script>
    ...
    messaging.getToken({
        vapidkey: "BMXV2uUz6EgdZJtHGAO1ASPLVmqRPognXoE0WiL7n2MAHfw6_JvOVjC8Uabw4aEvV5J3zhD69bUdEz5mgPRN_uU"
    }).then(currentToken => {
        if (currentToken) {
            console.log(currentToken)
            document.getElementById('token').value = `${currentToken}`
            // console.log(document.getElementById('token').value=`${currentToken}`);
    ...
    function sendTokenToServer(token) {
        //1st  check it if we already send it or not
        if (!isTokenSentToServer()) {
            console.log("Sending token to server ...");
            //if token is successfully send to the server
