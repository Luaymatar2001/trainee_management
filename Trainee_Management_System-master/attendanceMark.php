                    ...
                    <tr>
                        ...
                        <td>
                            <div class="col-md-12 col-sm-4">
                                <?php 
                                 $today=date('Y-m-d');
                                $sql22 = "SELECT *  FROM tbl_attendence WHERE  CurrentDate='$today 08:00:00' AND tblTraineeID = '$traineeId1' ";


                                $institute_data22 = $con->query($sql22);


                                if ($institute_data22->num_rows >= 1) {
