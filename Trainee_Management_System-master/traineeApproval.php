...
function notfiy($token, $send)
{
    //echo($token);
    // echo("<script>alert('sucsees')</script>");
    //echo("{$token}");
    $url = "https://fcm.googleapis.com/fcm/send";
    $server_key = "AAAAZIjsrwI:APA91bEKzIvCbNrIjy9YoJKp9vRKsr9kKC0kq-Y62cc5zOsCmyQzw6d19yvxfSvxC8RKcM5dXGFxKLjBNSc5o2AT7aFojDzqxWPHvJtHgqq5iDabiPQzZaFhJukgSRpq8bzoiFO1apzW";
    ...
    if ($send == 1) {
        $message = array(
            "data" => array(
                ...
                "body" => "this is message FROM BODY TO Rejected",
                "image" => "https://img.freepik.com/free-vector/colorful-bird-illustration-gradient_343694-1741.jpg?w=740&t=st=1685467567~exp=1685468167~hmac=eab5e6510ee27b4d007727251affddf7a59e14f84d2e0227ac1d27eb811272eb",
        ...
        $message = array(
            "data" => array(
                "title" => "your are accepted",
                "body" => "this is message is bucase your are accepted",
                "icon" => "http://localhost/Trainee_Management_System-master/Images//Mobitel_logo.png",
                "url" => "https://google.com/"
            ), "registration_ids" => [$token]
        );
    }
    ...
    if ($respones === false) {
        echo "Error Sending  " . curl_error($curl);
    } else {
...
$token = $con->query("SELECT (Token) FROM `tbl_trainee` WHERE tblTraineeID ='" . $_GET["id"] . "' ");
// while ($row = $token->fetch_assoc()) {
//     echo $row['Token']."<br>";
// }

if (isset($_GET["idDec"])) {
    $token = $con->query("SELECT (Token) FROM `tbl_trainee` WHERE tblTraineeID ='" . $_GET["idDec"] . "' ");
    $resalut = $token->fetch_assoc();
    //echo $resalut["Token"];
    notfiy($resalut["Token"], 1);
                ...
                <div class="panel-group">
                    <div class="panel panel-default">
                        ...
                        while ($row = $result->fetch_assoc()) { ?>
                            <img src="<?php echo "Images/" . $row['profile_img']; ?>" class="img-thumbnail thumb-xl img-thumbnail m-b-10" alt="profile-image" style="height: 150px; width: 130px; margin-top: 20px;" />
                        <?php } ?>
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_trainee_ID" id="v_Trainee_ID" placeholder="MOB/INOC/" value="<?php echo $T_id; ?>" disabled>
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <select class="form-control" name="v_title" id="v_title" autofocus="autofocus">
                                        ...
                                        <option value="MR" <?= $Title == 'MR' ? ' selected="selected"' : ''; ?>>--SELECT--</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_fname" id="v_Fname" placeholder="Full Name" onblur="this.value=this.value.toUpperCase()" value="<?php echo $Full_Name; ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_initials" id="v_initials" placeholder="Name with initials" onblur="this.value=this.value.toUpperCase()" value="<?php echo $Name_with_Initials; ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_nic" id="v_nic" placeholder="NIC Number" onblur="this.value=this.value.toUpperCase()" value="<?php echo $NIC; ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_dob" id="v_dob" placeholder="Date of birth" value="<?php echo $DOB; ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_age" id="v_age" placeholder="Age " onblur="this.value=this.value.toUpperCase()" value="<?php echo $Age; ?>"">
                            </div>
                            <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_add1" id="v_add1" placeholder="Address Line 1" onblur="this.value=this.value.toUpperCase()" value="<?php echo $Add_Line1; ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_add2" id="v_add2" placeholder="Address Line 2" onblur="this.value=this.value.toUpperCase()" value="<?php echo $Add_Line2; ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_add3" id="v_add3" placeholder="Address Line 3" onblur="this.value=this.value.toUpperCase()" value="<?php echo $Add_Line3; ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_tadd1" id="v_tadd1" placeholder="Temp. Address Line 1" onblur="this.value=this.value.toUpperCase()" value="<?php echo $Temp_Add_Line1; ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_tadd2" id="v_tadd2" placeholder="Temp. Address Line 2" onblur="this.value=this.value.toUpperCase()" value="<?php echo $Temp_Add_Line2; ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_tadd3" id="v_tadd3" placeholder="Temp. Address Line 3" onblur="this.value=this.value.toUpperCase()" value="<?php echo $Temp_Add_Line3; ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_mob1" id="v_mob1" placeholder="Mobile Number" onblur="this.value=this.value.toUpperCase()" value="<?php echo $Contact_Number1; ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="v_fno" id="v_fno" placeholder="Fixed Number" onblur="this.value=this.value.toUpperCase()" value="<?php echo $Contact_Number2; ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="email" class="form-control" name="v_email" id="v_email" placeholder="E-mail" value="<?php echo $E_Mail; ?>">
                                    </div>
                                    <?php if (isset($_POST["btnSubmit"])) { ?>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                                    ...
                                    <select class="form-control" name="v_institute" id="v_institute" value="<?php if (isset($_POST['btnSubmit'])) {
                                        ...
                                        if ($institute_data->num_rows >= 1) :
                                            while ($row = mysqli_fetch_assoc($institute_data)) : ?>
                                                <option value="<?php echo  $row["tblTrainingInstituteID"] ?>" <?php if ($row["tblTrainingInstituteID"] == $tblTrainingInstituteID) : ?> selected="selected" ; <?php endif ?>><?php echo $row["TrainingInstitute_Name"] ?></option>
                                        <?php
                                            endwhile;
                                        endif;
                                        ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <select class="form-control" name="v_program" id="v_program" value="<?php if (isset($_POST['btnSubmit'])) {
                                        ...
                                        <option value="CERTIFICATE" <?= $programName == 'CERTIFICATE' ? ' selected="selected"' : ''; ?>>--SELECT--</option>
                                    ...
                                    <select class="form-control" name="v_course" id="v_course" value="<?php if (isset($_POST['btnSubmit'])) {
                                        ...
                                        if ($course_data->num_rows >= 1) :
                                            while ($row = mysqli_fetch_assoc($course_data)) : ?>
                                                <option value="<?php echo  $row["tblCourseID"] ?>" <?php if ($row["tblCourseID"] == $tblCourseID) : ?> selected="selected" ; <?php endif ?>><?php echo  $row["Course_Name"] ?></option>
                                        <?php
                                            endwhile;
                                        endif;
                                        ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_batch" id="v_batch" placeholder="Batch" onblur="this.value=this.value.toUpperCase()" value="<?php echo $Batch; ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_year" id="v_year" placeholder="Year" onblur="this.value=this.value.toUpperCase()" value="<?php echo $Year; ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_con" id="v_con" placeholder="Contact Person" onblur="this.value=this.value.toUpperCase()" value="<?php echo $Contact_Person; ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_conNo" id="v_conNo" placeholder="Contact Number" onblur="this.value=this.value.toUpperCase()" value="<?php echo $Contact_number; ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_conRel" id="v_conRel" placeholder="Relationship" onblur="this.value=this.value.toUpperCase()" value="<?php echo $Relationship; ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_conAdd" id="v_conAdd" placeholder="Address" onblur="this.value=this.value.toUpperCase()" value="<?php echo $Address; ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
                    ...
                    <div class="panel panel-default">
                        ...
                        placeholder="Bank Name" value="<?php echo $tblBankID; ?>">-->
                                    <select class="form-control" name="v_bank" id="v_bank" value="<?php if (isset($_POST['btnSubmit'])) {
                                        ...
                                        if ($bank_data->num_rows >= 1) :
                                            while ($row = mysqli_fetch_assoc($bank_data)) : ?>
                                                <option value="<?php echo $row["tblBankID"] ?>" <?php if ($row["tblBankID"] == $tblBankID) : ?> selected="selected" ; <?php endif ?>><?php echo $row["Bank_Name"] ?></option>
                                        <?php
                                            endwhile;
                                        endif;
                                        ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_branch" id="v_branch" placeholder="Branch" onblur="this.value=this.value.toUpperCase()" value="<?php echo $branch ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_nameBank" id="v_nameBank" placeholder="Name As Bank" onblur="this.value=this.value.toUpperCase()" value="<?php echo $Name_as_Bank; ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_accNO" id="v_accNO" placeholder="Account Number" onblur="this.value=this.value.toUpperCase()" value="<?php echo $Bank_Account_number; ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
...
-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="date" class="form-control" name="v_jdate" id="v_jdate" placeholder="Join date" value="<?php echo $jdate; ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="date" class="form-control" name="v_edate" id="v_edate" placeholder="End date" value="<?php echo $edate; ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
