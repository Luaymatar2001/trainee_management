...
<head>
    ...
    <style>
        ...
        a:hover {
            ...
            transition: font-size 500ms !important;
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav ">
                    ...
                    if (in_array("5", $access_point)) : ?>
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Trainee<span class="caret"></span></a>
                    ...
                    if (in_array("8", $access_point)) : ?>
                        ...
                        <li class="dropdown">
                            <a href="rptTrainee.php" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Reports<span class="caret"></span></a>
                            <ul class="dropdown-menu">
