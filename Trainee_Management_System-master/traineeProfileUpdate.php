                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="v_dob" id="v_dob"
                                       placeholder="Date_of_Birth(Ex:-2020-00-00)" value="<?php echo $DOB; ?>">
                            </div>
                            <?php if (isset($_POST["btnSubmit"])) { ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                 ...
                                 <select class="form-control" name="v_program" id="v_program"
                                            ...
                                            <?php if($programName == 'CERTIFICATE') { ?>
                                            <option value='CERTIFICATE'>CERTIFICATE</option>
                                             <option value='DIPLOMA'>DIPLOMA</option>
                                             <option value='DEGREE'>DEGREE</option>
                                        <?php 
                                         }  if($programName == 'DIPLOMA') { ?>
                                            <option value='DIPLOMA'>DIPLOMA</option>
                                            <option value='CERTIFICATE'>CERTIFICATE</option>
                                            <option value='DEGREE'>DEGREE</option>
                                        <?php 
                                         }  if($programName == 'DEGREE') { ?>
                                            <option value='DEGREE'>DEGREE</option>
                                            <option value='CERTIFICATE'>CERTIFICATE</option>
                                             <option value='DIPLOMA'>DIPLOMA</option>
                                        <?php 
