                    ...
                    <div class="panel-body" style="background-color: transparent;">
                      <form class="form-horizontal m-t-10" action="" data-parsley-validate="" novalidate method="post">
                        <div class="form-group col-xs-12">
                          <input type="text" name="username" required="" class="form-control" id="username" placeholder="User Name" autocomplete="off" value="<?php if (isset($_COOKIE["member_login"])) {
                                                                                                                                                                echo $_COOKIE["member_login"];
                                                                                                                                                              } ?>" autofocus />
                        </div>
                        <div class="form-group col-xs-12">
                          <input id="pass1" name="pass1" type="password" placeholder="Password" required="" class="form-control" autocomplete="off" value="<?php if (isset($_COOKIE["member_password"])) {
                                                                                                                                                              echo $_COOKIE["member_password"];
                                                                                                                                                            } ?>" />
                          <div class="col-xs-12">
                            <div class="checkbox checkbox-custom">
                              <input id="checkbox-signup" type="checkbox" name="remember" <?php if (isset($_COOKIE["member_login"])) { ?>checked<?php } ?> />
                        ...
                        <div class="form-group text-center m-t-30">
                          <div class="col-xs-11">
                            <button class="btn btn-primary btn-bordred btn-block waves-effect waves-light text-uppercase" type="submit" name="btnsubmit">Log In </button>
                          </div>
                        </div>
